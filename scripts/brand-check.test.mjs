...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: !hasOgSkill || !hasAgents }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: !hasOgSkill || !hasAgents }, () => {
